...
static unsigned int compute_discard_granularity(struct f2fs_sb_info *sbi)
{
	...
	block_t fs_available_blocks_threshold
		= main_blocks * FS_AVAILABLE_SPACE_PERCENT / HUNDRED_PERCENT;
	block_t device_free_blocks_threshold
		= main_blocks * DEVICE_FREE_SPACE_PERCENT / HUNDRED_PERCENT;
