...
#ifdef CONFIG_HONOR_BINDER_TRANSACTION_BRIEF
	hn_transinfo = (struct hn_binder_transinfo *) (t + 1);
#endif
...
#ifdef CONFIG_HONOR_BINDER_TRANSACTION_BRIEF
		hn_transinfo->timestamp_binder =
			((struct hn_binder_transinfo *)(in_reply_to + 1))->timestamp_binder;
#endif
